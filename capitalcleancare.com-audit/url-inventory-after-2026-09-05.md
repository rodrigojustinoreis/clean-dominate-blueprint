# Inventário de URLs — dist-after
Fonte: `/private/tmp/claude-501/-Users-rodrigoreis-TESTE-BOSTA/0e87f069-21b6-4f41-ae93-7886ca560fb7/scratchpad/seo-phase1/dist-after` (build local prerenderizado) + `netlify.toml` (347 regras de redirect). Páginas prerenderizadas: **1224**. URLs no sitemap: **296**. Prerenderizadas fora do sitemap: **928**.
...
|---|---|---|---|
| /locations/germantown-md | 38 | 3.1 | 17 |
...
Destinos distintos: **939**; links (página×destino): **2181**. Top 20:
