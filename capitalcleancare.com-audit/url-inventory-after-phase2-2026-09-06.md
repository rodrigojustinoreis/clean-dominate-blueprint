...
Fonte: `/Users/rodrigoreis/TESTE BOSTA/.worktrees/seo-phase2/dist` (build local prerenderizado) + `netlify.toml` (347 regras de redirect). Páginas prerenderizadas: **1224**. URLs no sitemap: **296**. Prerenderizadas fora do sitemap: **928**.
...
|---|---|---|---|
| /locations/germantown-md | 38 | 3.1 | 18 |
| /locations/damascus-md | 37 | 3.0 | 14 |
| /locations/falls-church-va | 33 | 2.7 | 13 |
...
| /locations/germantown-md/recurring-cleaning | 3 | 0.2 | 2 |
| /locations/kensington-md/move-out-cleaning | 3 | 0.2 | 2 |
| /locations/north-bethesda-md/deep-cleaning | 3 | 0.2 | 2 |
...
Destinos distintos: **939**; links (página×destino): **2179**. Top 20:

| destino | noindex | status | páginas que linkam |
|---|---|---|---|
| /locations/germantown-md | 1 | 200 | 39 |
| /locations/damascus-md | 1 | 200 | 38 |
| /locations/falls-church-va | 1 | 200 | 34 |
...
| /locations/olney-md/recurring-cleaning | 1 | 200 | 5 |
