...
export default async (req) => {
  ...
  if (!RESEND_API_KEY) {
    console.warn("RESEND_API_KEY not set — email notification skipped. Data was saved to Supabase and Netlify Forms.");
...
<body style="margin:0;padding:0;background:#f3f4f6;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  ...
  try {
    ...
    // Still return 200 — data was saved to Supabase and Netlify Forms
