...
import MaidServicePage from "./pages/MaidServicePage";
...
import HowToGetRidOfMildewSmellNaturally from "./pages/HowToGetRidOfMildewSmellNaturally";
import HowToGetCigaretteSmellOutOfYourHouse from "./pages/HowToGetCigaretteSmellOutOfYourHouse";
import HowToRemoveSharpieSafely from "./pages/HowToRemoveSharpieSafely";
...
import PetDanderAirQuality from "./pages/PetDanderAirQuality";
import PetSneezingHouseholdDust from "./pages/PetSneezingHouseholdDust";
import AllergenFreeHomeForPets from "./pages/AllergenFreeHomeForPets";
...
import ToddlerCleaningSchedule from "./pages/ToddlerCleaningSchedule";
import PreschoolBackpackLunchbox from "./pages/PreschoolBackpackLunchbox";
...
import KitchenCleaningChecklist from "./pages/KitchenCleaningChecklist";
import LivingRoomCleaningChecklist from "./pages/LivingRoomCleaningChecklist";
...
import SeniorHomeCleaningDC from "./pages/SeniorHomeCleaningDC";
import SeniorHomeCleaningNoVA from "./pages/SeniorHomeCleaningNoVA";
...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/services/living-area-cleaning" element={<LivingAreaCleaningPage />} />
