...
const PostConstructionPreview = lazy(() => import("./pages/PostConstructionPreview"));
...
const CaregiverGuideHouseCleaning = lazy(() => import("./pages/CaregiverGuideHouseCleaning"));
...
const BackToSchoolCleaningChecklist = lazy(() => import("./pages/BackToSchoolCleaningChecklist"));
