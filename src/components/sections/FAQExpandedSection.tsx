...
const DEFAULT_FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Sí. Tenemos reseñas verificadas en Google con calificación 5.0, muchas de clientes en Silver Spring, Wheaton, Rockville y Gaithersburg. Puedes verlas en Google Maps buscando 'Capital Clean Care'. También podemos conectarte con clientes actuales si lo prefieres.",
  },
  {
