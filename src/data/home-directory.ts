// Light card/link data for the eager home graph — AUTO-EXTRACTED (npx tsx) from
// vanity-landings.ts and services.ts. Importing the full modules from the home
// dragged ~137KB gz of page copy into every visitor's initial JS. Keep in sync.
export const dirVanity: { slug: string; h1: string; metaDescription: string }[] = [
  {
...
export const dirServiceCards: { slug: string; name: string; shortDescription: string }[] = [
  {
    "slug": "house-cleaning",
    "name": "House Cleaning",
