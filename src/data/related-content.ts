...
export const MANUAL_RELATED_POSTS: Record<string, string[]> = {
  ...
  "cleaning-schedule-working-parents-toddlers": ["baby-crawling-floor-cleaning-guide", "bringing-baby-home-cleaning-guide", "cleaning-tips-for-working-professionals", "is-professional-house-cleaning-worth-it", "how-to-keep-house-clean-between-cleanings"],
