...
export const MANUAL_RELATED_POSTS: Record<string, string[]> = {
  ...
  "cleaning-during-pregnancy-prepare-home-for-baby": ["bringing-baby-home-cleaning-guide", "what-is-included-in-a-deep-cleaning", "move-in-cleaning-checklist", "how-to-prepare-home-for-professional-cleaning", "deep-cleaning-checklist-dmv-homeowners", "eco-cleaning-tips-maryland-homes"],
  ...
  "how-to-clean-a-backpack-and-lunch-box": ["cleaning-schedule-working-parents-toddlers", "baby-crawling-floor-cleaning-guide", "cleaning-tips-for-working-professionals", "how-to-keep-house-clean-between-cleanings", "is-professional-house-cleaning-worth-it"],
