...
export const ROUTE_MAP_EN_TO_ES: Record<string, string> = {
  ...
  "/about": "/es/nosotros",
  "/contact": "/es/contacto",
  "/house-cleaning": "/es/limpieza-de-casas",
  "/deep-cleaning": "/es/limpieza-profunda",
  "/move-out-cleaning": "/es/limpieza-de-mudanza",
  "/airbnb-cleaning": "/es/limpieza-airbnb",
  "/post-construction-cleaning": "/es/limpieza-post-construccion",
  "/recurring-cleaning": "/es/limpieza-recurrente",
