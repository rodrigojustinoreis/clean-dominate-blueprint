...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How much does deep cleaning cost?", a: "Deep cleaning pricing depends on home size, number of bedrooms and bathrooms, and current condition. A typical 3-bedroom home ranges from $375–$445. Request a free quote for accurate pricing." },
    ...
    metaDescription: "Professional deep cleaning service in Montgomery County & the DMV — inside appliances, baseboards, vents & grout, top to bottom. Eco-friendly & insured. Free quote."
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Is post-construction dust harmful?", a: "It can be. Particles below 10 microns stay suspended in the air rather than settling, and below 4 microns they get past the nose and throat into the lungs. Drywall compound, concrete, mortar and tile cutting can release respirable crystalline silica, which OSHA regulates exposure to on jobsites. That is why we filter the air during the clean with a HEPA air scrubber instead of only wiping surfaces, and why the job is split into phases. We do not perform formal air quality testing; if you need measured results, an environmental testing service is the right call." },
      { q: "What equipment do you use for post-construction cleaning?", a: "HEPA-filtered vacuums for surfaces and floors, plus an XPOWER X-2580 air scrubber running during the work. The X-2580 is a 1/2 HP unit that moves up to 550 CFM through four filtration stages: two washable nylon mesh screens for medium and large debris, an activated carbon stage for paint and adhesive odours, and a true HEPA filter rated at 99.97% of particles at 0.3 microns. Its outlet can be ducted, so we can hold a room at negative pressure and vent filtered air away from the areas already finished." },
      ...
      { q: "What is post-construction cleaning?", a: "Post-construction cleaning is the detailed clean that takes a property from buildable to liveable after construction or remodeling work is finished. It removes the fine dust that building work leaves behind on every surface, along with debris, paint and adhesive residue, protective film on new fixtures and appliances, sticker labels, and grout haze on new tile. It is a different job from a regular house cleaning because of the dust: drywall compound, concrete and tile cutting produce particles fine enough to stay suspended in the air, travel into closets, cabinets, vents and light fixtures, and keep settling for 48 to 72 hours after the crew leaves. That behaviour dictates the method. The work runs from the highest surfaces down to the floor, uses sealed HEPA-filtered equipment so captured dust does not blow back into the room, and is inspected and repeated where dust returns." },
      { q: "What does post-construction cleaning include?", a: "The core of it is every surface the dust reached: ceilings and upper walls, light fixtures and fans, HVAC register and return covers, walls, doors and frames, window glass, sills and tracks, cabinets and closets inside and out, shelving, trim and baseboards, then floors. It also covers the residue construction leaves that ordinary cleaning never meets, including paint spatter, adhesive, protective film on appliances and fixtures, label glue and grout haze. Edges, corners and transitions get their own pass, because that is where a line of dust stays visible after the middle of the room looks finished. Exact scope depends on the property and gets confirmed in writing before the appointment, since a basement finish and a whole-house renovation are not the same job." },
      { q: "Can I clean construction dust myself, or should I hire someone?", a: "You can do a lot of it yourself. Loose debris, bulk dust and the obvious surfaces are within reach of anyone willing to put in the hours. Two things make it harder than it looks. A household or shop vacuum that is not sealed pushes the finest dust back out through its exhaust and housing seams, so the floor looks clean while the respirable fraction moves into the air and lands again on what you already wiped. And because dust keeps settling for 48 to 72 hours, a single cleaning day usually gets undone by the third morning. If you do it yourself, rent or borrow a sealed HEPA vacuum rather than using a shop vac, work top to bottom, and plan on more than one pass. Hiring out makes most sense on larger jobs, heavy drywall work, or when you need the place finished by a date." },
      { q: "Who is responsible for cleanup after construction, me or the contractor?", a: "Check the contract, because this is where most of the confusion starts. A construction contract normally obliges the contractor to remove their debris and leave the site broom-clean, which means bulk waste hauled out and floors swept. It rarely includes the detailed final clean: fine dust on every surface, windows and tracks, fixtures, cabinet interiors, grout haze, adhesive and film removal. Arranging that is usually the owner's responsibility, and it is the part people are surprised by. If your contract does cover a final clean, ask what standard it is held to and whether HEPA-filtered equipment is used, because broom-clean and move-in-ready are very different conditions." },
      { q: "How do I choose a post-construction cleaning service?", a: "Ask about equipment, sequence and scope. On equipment, ask whether the vacuum body is sealed rather than just fitted with a HEPA cartridge, since an unsealed machine returns fine dust to the room. On sequence, ask how the visits are spaced: dust settles for 48 to 72 hours after the work stops, so a company that plans one visit on the day the contractors leave is planning to be called back. On scope, get it in writing before anyone starts, and check four items by name: cabinet interiors, appliance interiors, window tracks and grout haze. Those are the ones most often assumed by the customer and left out of the quote. Confirm insurance as well, since the work happens around new finishes that are expensive to repair." },
      { q: "What is eco-friendly post-construction cleaning?", a: "In post-construction work the environmental question is mostly about where the dust ends up, not about what is in the bottle. Sealed HEPA filtration keeps captured particles inside the machine instead of returning them to your indoor air, and a wet-dry floor washer holds recovered dirty water in a separate tank rather than spreading it across the room. On top of that we use plant-based, low-odour products, which matters in a freshly finished space where windows may stay shut and paint and sealant fumes are still present. Any cleaner claiming a greener result while running an unsealed vacuum through drywall dust has the priority backwards." },
      { q: "How much does post-construction cleaning cost?", a: "We price post-construction work after a technician assesses the property, rather than from a published rate. Size alone does not predict it: two houses of the same square footage can take very different amounts of work depending on how the trades left them. The assessment reads the dust load and how far it travelled, whether debris and packaging were hauled out, how much paint spatter, adhesive, sealant and label residue sits on the surfaces, the floor material and whether it can take moisture, and how many separate surfaces the finished rooms hold. A kitchen or bathroom remodel carries far more individual surfaces than an empty room of the same size. The assessment is free, and you get a written scope with the price on it before any work starts." },
      { q: "Is construction cleaning the same as post-construction cleaning?", a: "Yes. They describe the same work. \"Construction cleaning,\" \"post-construction cleaning,\" \"post-renovation cleaning\" and \"final construction clean\" all refer to the detailed clean that removes drywall dust, debris, paint residue and adhesive film after building or remodeling work is finished. What matters is the stage: a rough clean can happen mid-project, while the final clean happens once contractors are done and debris has been hauled out." },
  ...
  {
    name: "Condo Cleaning",
    h1: "Condo Cleaning Services in Maryland, DC & Northern Virginia",
    slug: "condo-cleaning",
    shortDescription: "HOA-friendly condo & high-rise cleaning across MD, DC & Northern Virginia — fully insured, with elevator, fob, and front-desk access handled.",
    intro: "Condo living comes with its own rules, and cleaning a condo is not the same as cleaning a single-family house. There is no yard, garage, or exterior — just the interior spaces you live in, where every surface is on display — plus building realities most cleaners overlook: HOA requirements, certificates of insurance for management, key fobs, elevators, loading-dock scheduling, and quiet hours. Capital Clean Care handles all of it.\n\nOur crews are fully licensed, bonded, and insured, and we provide a Certificate of Insurance (COI) to your building or HOA on request, so we clear board-approved-vendor requirements without the back-and-forth. We coordinate elevator and loading-dock times, work respectfully in shared hallways, and follow your building's access procedures — front desk, fob, or lockbox.\n\nEvery visit uses our EPA Safer Choice™ plant-based products — non-toxic and low-odor, which matters even more in a smaller, sealed condo where the windows may not open. From the kitchen and bathrooms to the sleeping and living areas, we thoroughly clean the spaces you actually use, every single time.\n\nWhether you own a downtown high-rise unit, a mid-rise flat, or a condo you rent out, we build a cleaning plan around your schedule and your building — weekly, bi-weekly, monthly, or a one-time deep clean, with no contracts.",
    whatsIncluded: [
      "Kitchen — counters, stovetop, sink and appliance exteriors wiped and sanitized",
      "Kitchen floor swept and mopped, trash emptied and relined",
      "Bathrooms — toilet, shower, tub, tile and sink scrubbed and disinfected",
      "Mirrors and fixtures polished streak-free, fresh towels staged",
      "Bedrooms — beds made, surfaces and furniture dusted, floors vacuumed or mopped",
      "Living areas — dusting, cushions straightened, high-touch points sanitized",
      "Interior glass, windowsills and window tracks wiped",
      "Baseboards, light switches, door handles and remotes wiped down",
      "All hard floors mopped and carpets and rugs vacuumed",
      "Balcony or patio quick tidy where accessible",
      "Add-ons available: inside the oven, inside the fridge, interior windows, laundry",
      "Certificate of Insurance provided to your building or HOA on request",
    ],
    benefits: [
      "HOA-friendly — Certificate of Insurance (COI) provided to your building on request",
      "Elevator, loading-dock, fob and front-desk access all coordinated",
      "Fully licensed, bonded, insured and background-checked teams",
      "Eco-friendly, low-odor plant-based products — ideal for sealed condos",
      "Flexible weekly, bi-weekly, monthly or one-time plans — no contracts",
      "The same dedicated team that learns your unit and your building",
      "Respectful of posted quiet hours and shared-hallway etiquette",
      "Backed by our 24-hour re-clean guarantee",
    ],
    faqs: [
      { q: "Do you provide a Certificate of Insurance (COI) for my building or HOA?", a: "Yes. Capital Clean Care is fully licensed, bonded, and insured, and we can provide a Certificate of Insurance to your building management or HOA on request — so we meet board-approved-vendor requirements before the first visit." },
      { q: "How do you handle building access — fobs, elevators, and the front desk?", a: "We coordinate directly with your building's procedures: checking in at the front desk, using a fob or code you provide, or a lockbox arrangement, plus scheduling the service elevator or loading dock when your building requires it. We also respect posted quiet hours." },
      { q: "How is condo cleaning different from house cleaning?", a: "A condo is an interior-only footprint — no yard, garage, or exterior — so the whole visit focuses on the living spaces, and the detail shows more. The bigger difference is the building: HOA rules, COI requirements, elevators, fobs, and shared hallways, all of which we handle as part of the service." },
    ...
    metaDescription: "Condo cleaning across MD, DC & Northern Virginia — HOA-friendly, fully insured (COI provided), elevator & fob access handled. Get a free quote today.",
  },
  {
    name: "Maid Service",
    h1: "Professional Maid Service in Maryland, DC & Virginia",
    slug: "maid-service",
    shortDescription: "Vetted, insured, background-checked maids cleaning homes across Maryland, DC & Northern Virginia — one-time or on a regular schedule.",
    intro: "A maid service takes cleaning off your plate entirely: professional maids come to your home, work through a thorough room-by-room routine, and leave it spotless — so you get your evenings and weekends back. Capital Clean Care is the maid service the DMV trusts, with the same dependable, familiar faces on every visit.\n\nEvery one of our maids is background-checked, bonded, and insured, arrives in uniform, and is trained on our detailed checklist. You get a dedicated team that learns your home and your preferences, not a different stranger each time. It is a maid service you can actually feel comfortable handing a key to.\n\nWe use EPA Safer Choice™ plant-based products — non-toxic and safe for kids and pets — on every visit, and we back every clean with a 24-hour re-clean guarantee. Whether you want a maid once, once a week, or somewhere in between, we build the plan around your home and your schedule, with no contracts.\n\nNot sure which fits? A one-time reset is our house cleaning or deep cleaning; ongoing upkeep is our recurring maid service. This page is the starting point — tell us your home and we will point you to the right one.",
    whatsIncluded: [
      "Kitchen — counters, stovetop, sink and appliance exteriors wiped and sanitized",
      "Kitchen floor swept and mopped, trash emptied and relined",
      "Bathrooms — toilet, shower, tub, tile and sink scrubbed and disinfected",
      "Mirrors and fixtures polished, fresh towels staged",
      "Bedrooms — beds made, surfaces and furniture dusted, floors vacuumed or mopped",
      "Living areas — dusting, cushions straightened, high-touch points sanitized",
      "Interior glass, windowsills and window tracks wiped",
      "Baseboards, light switches, door handles and remotes wiped down",
      "All hard floors mopped and carpets and rugs vacuumed",
      "Add-ons available: inside the oven, inside the fridge, interior windows, laundry",
      "Final walkthrough and quality check on every visit",
    ],
    benefits: [
      "Background-checked, bonded and insured maids — never a random stranger",
      "The same dedicated maid or team that learns your home",
      "Uniformed, trained professionals following a detailed checklist",
      "One-time or recurring — weekly, bi-weekly or monthly, with no contracts",
    ...
    faqs: [
      ...
      { q: "What's the difference between a maid service and house cleaning?", a: "They describe the same thing — professionals cleaning your home. 'Maid service' usually implies an ongoing, trusted relationship with the same team, while a one-time clean is often just called a house cleaning or deep cleaning. We offer both: a single visit, or a recurring maid service on the schedule you choose." },
      { q: "Are your maids insured and background-checked?", a: "Yes. Capital Clean Care is fully licensed, bonded, and insured, and every maid is background-checked before they ever enter a client's home. Our teams arrive in uniform and are trained on our checklist, so you always know exactly who is in your home." },
      { q: "Can I get the same maid every time?", a: "Yes — that consistency is the whole point of a maid service. We assign a dedicated maid or team that learns your home and your preferences, so you see familiar, trusted faces on every recurring visit." },
      { q: "Do you offer one-time or recurring maid service?", a: "Both. Book a single visit whenever you need it, or set up a recurring maid service — weekly, bi-weekly, or monthly — with preferred pricing and no contracts. You can shift, add, or skip visits anytime." },
      { q: "Do you offer maid service near me?", a: "We provide maid service across Montgomery County and the wider DMV — Rockville, Bethesda, Silver Spring, Gaithersburg, Germantown, Arlington, Alexandria, Washington DC, and more. Enter your address in a free quote and we'll confirm coverage." },
    ],
    testimonials: [],
    metaTitle: "Maid Service in MD, DC & VA | Capital Clean Care",
    metaDescription: "Looking for a trusted maid service near you? Capital Clean Care's vetted, insured maids clean homes across Maryland, DC & Northern Virginia. Book online.",
  },
  {
  ...
  },
  {
    ...
    h1: "Kitchen Cleaning Services in Maryland, DC & Northern Virginia",
    slug: "kitchen-cleaning",
    shortDescription: "Professional kitchen cleaning across MD, DC & Northern Virginia — degreased stovetop and range hood, spotless appliance exteriors, sanitized sink and counters. Insured team, one-time or recurring.",
    intro: "The kitchen is the hardest-working room in the house — and the hardest to keep clean. Grease builds up on the stovetop and range hood, appliance doors collect fingerprints, and the sink and backsplash take a beating every single day. Capital Clean Care's kitchen cleaning service handles all of it, so you come home to a kitchen that actually feels fresh.\n\nOur insured, background-checked DMV team degreases your stovetop, burners, and range hood, wipes down every appliance exterior, scrubs and sanitizes the sink and faucet, cleans the cabinet fronts and backsplash, and finishes the floors — using EPA Safer Choice™ plant-based products that are non-toxic and safe around food, kids, and pets.\n\nWant the inside of the oven or the refrigerator done too? Those are simple add-ons. And because most people want their kitchen kept this way, you can book a one-time kitchen cleaning or set up recurring visits — weekly, bi-weekly, or monthly — with no contracts and a flat per-visit price.\n\nServing Maryland, Washington DC, and Northern Virginia, we make it easy to book a professional kitchen cleaning near you. Tell us about your kitchen and get a free, flat-price quote in minutes.",
    whatsIncluded: [
      "Degrease and clean the stovetop, burners, grates, and drip pans",
      "Degrease the range hood and wash the exhaust filter",
      "Wipe and shine all appliance exteriors — refrigerator, oven, dishwasher, microwave",
      "Scrub and sanitize the sink, faucet, and garbage-disposal area",
      "Clean and polish the backsplash and tile",
      "Wipe cabinet fronts, handles, and hardware",
      "Clean and disinfect all countertops, edges, and undersides",
      "Wipe small-appliance exteriors and the surrounding staging areas",
      "Clean the kitchen table, chairs, and high-touch points",
      "Sweep and mop the kitchen floor, including edges and corners",
      "Empty and reline the trash and recycling bins",
      "Add-ons available: inside the oven, inside the refrigerator, interior windows",
    ],
    benefits: [
      "The room that gets the dirtiest — degreased and sanitized properly",
      "Insured, background-checked, uniformed DMV team you can trust",
      "EPA Safer Choice™ plant-based products — non-toxic and food-safe",
      "One-time or recurring — weekly, bi-weekly or monthly, with no contracts",
      "Simple add-ons: inside the oven, inside the fridge, interior windows",
      "Flat per-visit pricing — never an open-ended hourly rate",
      "Professional kitchen cleaning near you across MD, DC & Northern Virginia",
      "Backed by our 24-hour re-clean guarantee",
    ],
    faqs: [
      { q: "How much does a kitchen cleaning service cost?", a: "Kitchen cleaning is quoted as a flat per-visit price based on the size and condition of your kitchen and any add-ons you choose — never an open-ended hourly rate. Request a free quote and we'll give you an exact number for your kitchen." },
      { q: "How long does a professional kitchen cleaning take?", a: "A standard kitchen usually takes about 1 to 2 hours. Adding the inside of the oven or refrigerator, or a heavier degrease, adds time — we'll confirm the estimate when we quote your kitchen." },
      { q: "Do you degrease the stovetop and range hood?", a: "Yes — degreasing the stovetop, burners, grates, and the range hood and its filter is part of every kitchen cleaning. It's the buildup most people can't stay on top of, so it's the core of what we do." },
      { q: "Do you clean inside the oven and refrigerator?", a: "The standard kitchen cleaning covers all appliance exteriors. Inside the oven and inside the refrigerator are popular add-ons — just let us know when you book and we'll include them in your flat quote." },
      { q: "What cleaning products do you use in the kitchen?", a: "We use EPA Safer Choice™ plant-based, non-toxic products that are safe to use around food, children, and pets. No harsh chemical smell lingering on your counters or in your air after we leave." },
      { q: "Can I set up recurring kitchen cleaning?", a: "Yes. Many clients keep their kitchen fresh with recurring visits — weekly, bi-weekly, or monthly — with no contracts, so you can adjust, add, or skip a visit whenever you need." },
      { q: "Do you offer kitchen cleaning near me?", a: "We provide kitchen cleaning near you across Montgomery County and the wider DMV — Rockville, Bethesda, Silver Spring, Gaithersburg, Germantown, and throughout Maryland, Washington DC, and Northern Virginia. Share your address in a free quote and we'll confirm coverage." },
      { q: "How is a kitchen cleaning different from a deep cleaning?", a: "A kitchen cleaning focuses on one room — your kitchen — done thoroughly. A deep cleaning is a whole-home, top-to-bottom service. If you want the whole house handled, we'll point you to our deep cleaning; if it's really the kitchen you want kept clean, this is the service." },
    ],
    testimonials: [],
  ...
  },
  {
    ...
    h1: "Bathroom Cleaning Services in Maryland, DC & Northern Virginia",
    slug: "bathroom-cleaning",
    shortDescription: "Professional bathroom cleaning across MD, DC & Northern Virginia — sanitized toilet, scrubbed shower and tub, detailed tile and grout, polished vanity and mirror. Insured team, one-time or recurring.",
    intro: "The bathroom is the room that has to be truly clean — not just tidy. Soap scum on the glass, hard-water spots on the fixtures, grime in the grout, and a toilet that needs more than a quick wipe. Capital Clean Care's bathroom cleaning service handles the whole room, sanitized top to bottom, so it actually feels fresh.\n\nOur insured, background-checked DMV team scrubs and disinfects the toilet inside and out, descales the shower, tub, and glass doors, details the tile and grout, polishes the vanity, sink, fixtures, and mirror, wipes the exhaust fan, and washes the floor into the corners — using EPA Safer Choice™ plant-based products that are non-toxic and safe for your family.\n\nWant the grout deep-scrubbed or heavy hard-water buildup descaled? Those are simple add-ons. And because bathrooms don't stay clean on their own, you can book a one-time bathroom cleaning or set up recurring visits — weekly, bi-weekly, or monthly — with no contracts and a flat per-visit price.\n\nServing Maryland, Washington DC, and Northern Virginia, we make it easy to book a professional bathroom cleaning near you. Tell us about your bathroom and get a free, flat-price quote in minutes.",
    whatsIncluded: [
      "Scrub, disinfect and deodorize the toilet — bowl, seat, lid, base and behind",
      "Wipe down the toilet tank exterior and surrounding wall",
      "Scrub the shower walls, floor, and glass doors — remove soap scum and hard-water spots",
      "Clean and disinfect the bathtub, including jets where applicable",
      "Detail the tile and grout; polish chrome, nickel and brass fixtures",
      "Clean and disinfect the vanity countertop and sink",
      "Wipe cabinet fronts, handles and drawer pulls",
      "Clean the mirror and any glass streak-free",
      "Wipe the exhaust fan cover and light fixtures",
      "Sweep and mop the floor into corners and along baseboards",
      "Empty and reline the trash, restock and fold fresh towels",
      "Add-ons available: grout deep-scrub, hard-water descaling, interior window",
    ],
    benefits: [
      "A truly sanitized bathroom — toilet, shower and tub done right, not just wiped",
      "Insured, background-checked, uniformed DMV team you can trust",
      "EPA Safer Choice™ plant-based products — non-toxic and safe for your family",
      "One-time or recurring — weekly, bi-weekly or monthly, with no contracts",
      "Simple add-ons: grout deep-scrub, hard-water descaling, interior windows",
      "Flat per-visit pricing — never an open-ended hourly rate",
      "Professional bathroom cleaning near you across MD, DC & Northern Virginia",
      "Backed by our 24-hour re-clean guarantee",
    ],
    faqs: [
      { q: "How much does a bathroom cleaning service cost?", a: "Bathroom cleaning is quoted as a flat per-visit price based on the size and condition of your bathroom, the number of bathrooms, and any add-ons — never an open-ended hourly rate. Request a free quote and we'll give you an exact number." },
      { q: "How long does a professional bathroom cleaning take?", a: "A standard bathroom usually takes about 45 minutes to an hour and a half. Heavy soap-scum, hard-water descaling, or a grout deep-scrub adds time — we'll confirm the estimate when we quote your bathroom." },
      { q: "Do you remove soap scum and hard-water stains from the shower?", a: "Yes — descaling the shower glass, walls, and fixtures and removing soap scum and hard-water spots is part of every bathroom cleaning. For heavy mineral buildup we offer a hard-water descaling add-on." },
      { q: "Do you scrub the tile and grout?", a: "Every bathroom cleaning includes detailing the tile and grout lines. For grout that's badly stained or discolored, add our grout deep-scrub and we'll bring it back as far as it will go." },
      { q: "What cleaning products do you use in the bathroom?", a: "We use EPA Safer Choice™ plant-based, non-toxic disinfectants and cleaners — effective on bathroom germs without the harsh chemical smell lingering in a small, enclosed room." },
      { q: "Can I set up recurring bathroom cleaning?", a: "Yes. Many clients keep their bathrooms fresh with recurring visits — weekly, bi-weekly, or monthly — with no contracts, so you can adjust, add, or skip a visit whenever you need." },
      { q: "Do you offer bathroom cleaning near me?", a: "We provide bathroom cleaning near you across Montgomery County and the wider DMV — Rockville, Bethesda, Silver Spring, Gaithersburg, Germantown, and throughout Maryland, Washington DC, and Northern Virginia. Share your address in a free quote and we'll confirm coverage." },
      { q: "How is a bathroom cleaning different from a deep cleaning?", a: "A bathroom cleaning focuses on one room — your bathroom — sanitized thoroughly. A deep cleaning is a whole-home, top-to-bottom service. If you want the whole house handled, we'll point you to our deep cleaning; if it's really the bathrooms you want kept clean, this is the service." },
    ],
    testimonials: [],
    metaTitle: "Bathroom Cleaning Services MD, DC & VA | Capital Clean Care",
    metaDescription: "Professional bathroom cleaning across MD, DC & Northern Virginia — toilet, shower & tub, tile & grout, vanity, mirror, fan & floor. Insured team. Free quote.",
  },
  {
    name: "Living Areas Cleaning",
    h1: "Living Areas Cleaning Services in Maryland, DC & Northern Virginia",
    slug: "living-area-cleaning",
    shortDescription: "Professional living area cleaning across MD, DC & Northern Virginia — living room, dining room, home office and family room: dusted, vacuumed, and straightened. Insured team, one-time or recurring.",
    intro: "The living spaces of your home — the living room, dining room, home office, playroom, and more — are meant to be used by the people who live there, not kept as showrooms. That doesn't mean they can't look and feel clean on a regular basis. Capital Clean Care gets all your home's living areas into tip-top shape without you ever having to lift a finger.\n\nOur insured, background-checked DMV team vacuums the upholstered furniture, fluffs the cushions, dusts everything from ceiling fans to baseboards, removes fingerprints from woodwork and switch plates, and vacuums and washes the floors — using EPA Safer Choice™ plant-based products that are non-toxic and safe for your family and pets.\n\nWhether you want your living areas cleaned weekly, bi-weekly, or once a month, we've got you covered — with no contracts and a flat per-visit price. Spend less time cleaning, and more time actually living in your space.\n\nServing Maryland, Washington DC, and Northern Virginia, we make it easy to get your living areas cleaned your way. Tell us about your home and get a free, flat-price quote in minutes.",
    whatsIncluded: [
      ...
      "Add-ons available: interior windows, inside cabinets, upholstery refresh",
    ],
    benefits: [
      "The rooms you actually live in — kept genuinely clean, not just tidy",
      "Insured, background-checked, uniformed DMV team you can trust",
      "EPA Safer Choice™ plant-based products — non-toxic and safe for kids and pets",
      "One-time or recurring — weekly, bi-weekly or monthly, with no contracts",
      "Flat per-visit pricing — never an open-ended hourly rate",
      "Flexible — tell us your home's special needs and we clean it your way",
      "Living area cleaning near you across MD, DC & Northern Virginia",
      "Backed by our 24-hour re-clean guarantee",
    ],
    faqs: [
      { q: "What counts as a living area?", a: "Living areas are the shared spaces you actually live in — the living room, family room, dining room, home office, playroom, and hallways. They're meant to be used, so the goal is rooms that look and feel clean on a regular basis without you having to lift a finger." },
      { q: "How much does living area cleaning cost?", a: "Living area cleaning is quoted as a flat per-visit price based on the size of your home and how many rooms you want covered — never an open-ended hourly rate. Request a free quote for an exact number." },
      { q: "What's included in a living area cleaning?", a: "Upholstered furniture vacuumed and cushions fluffed, ceiling fans and lampshades dusted, furniture dusted top-front-and-underneath, picture frames dusted, fingerprints removed from woodwork and switch plates, floors vacuumed and washed, baseboards and windowsills wiped, general straightening, and trash emptied." },
      { q: "Can I set up recurring living area cleaning?", a: "Yes. Most clients keep their living areas fresh with recurring visits — weekly, bi-weekly, or monthly — with no contracts, so you can shift, add, or skip a visit whenever you need." },
      { q: "Do you offer living area cleaning near me?", a: "We provide living area cleaning near you across Montgomery County and the wider DMV — Rockville, Bethesda, Silver Spring, Gaithersburg, Germantown, and throughout Maryland, Washington DC, and Northern Virginia. Share your address in a free quote and we'll confirm coverage." },
      { q: "Do you also clean kitchens and bathrooms?", a: "Yes. Living areas are usually cleaned as part of a whole-home visit that also covers the kitchen and bathrooms. Want just one room? We offer dedicated kitchen cleaning and bathroom cleaning too — or fold everything into a house cleaning or deep cleaning." },
    ],
    testimonials: [],
