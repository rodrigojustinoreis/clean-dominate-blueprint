...
export const whyChooseVariants: ((c: WhyCtx) => string[])[] = [
  (c) => [
    ...
    `Flexible scheduling designed for busy ${c.city} households`,
  ...
  (c) => [
    ...
    `Flexible appointment times for busy ${c.city} households`,
  ...
  (c) => [
    ...
    `Dependable scheduling that fits busy ${c.city} households`,
