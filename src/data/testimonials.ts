...
const serviceTestimonialsMap: Record<string, Record<string, Testimonial[]>> = {
  "house-cleaning": {
    "rockville-md": [
      ...
      { name: "Patricia W.", location: "King Farm, Rockville MD", date: "2026-03-05", text: "Capital Clean Care has been cleaning our home in King Farm for over a year. The GreenShield method is incredible — no chemical smell, everything spotless. My kids and dog are safe and I never worry about what products they use." },
      { name: "David R.", location: "Fallsgrove, Rockville MD", date: "2026-03-12", text: "I've tried three cleaning companies in Rockville before finding Capital Clean Care. The difference is night and day. They're thorough, punctual, and the eco-friendly products actually work better than the harsh stuff other companies use." },
      { name: "Aisha M.", location: "Twinbrook, Rockville MD", date: "2026-03-18", text: "Booked a move-out clean for my apartment in Twinbrook and got my full security deposit back. The team was professional and detail-oriented. Highly recommend for anyone moving in or out in Rockville." },
      { name: "Carlos S.", location: "Woodley Gardens, Rockville MD", date: "2026-03-22", text: "As someone with allergies, finding a truly non-toxic cleaning service was a priority. Capital Clean Care uses EPA Safer Choice products and I can actually breathe freely after they clean. Worth every penny." },
      { name: "Lisa T.", location: "College Gardens, Rockville MD", date: "2026-04-02", text: "Recurring bi-weekly cleaning and I couldn't be happier. Same team every visit, they know my home and my preferences. The consistency is what sets Capital Clean Care apart from everyone else in Rockville." },
      { name: "Michael K.", location: "Tower Oaks, Rockville MD", date: "2026-04-10", text: "Used Capital Clean Care for post-construction cleaning after our renovation. They handled everything — dust, debris, windows. The house looked brand new. Best cleaning service I've hired in the DMV area." },
    ],
    "bethesda-md": [
