...
export const vanityLandingPages: VanityLandingConfig[] = [
  {
    ...
    metaTitle: "House Cleaning in Wheaton MD (20902) | Capital Clean Care",
    metaDescription: "Professional house cleaning in Wheaton, MD near Silver Spring. Eco-friendly products, background-checked teams. Serving Wheaton Hills, Glenmont & Brookside. Free quotes.",
    zip: "20902",
  ...
  },
  {
    ...
    metaTitle: "Eco-Friendly Cleaning in Bethesda MD | Capital Clean Care",
    metaDescription: "Plant-based, non-toxic house cleaning in Bethesda, MD. Safe for families, pets & premium surfaces. Serving Burning Tree, Edgemoor, Kenwood. Free quotes.",
    zip: "20814",
  ...
  },
  {
    ...
    metaTitle: "Deep Cleaning in Germantown MD | Capital Clean Care",
    metaDescription: "Intensive deep house cleaning in Germantown, MD. Inside appliances, baseboards, vents & more. Eco-friendly products. Serving Churchill, Milestone, Clopper Mill. Free quotes.",
    zip: "20874",
  ...
  },
  {
    ...
    metaTitle: "House Cleaning in Silver Spring MD (20910) | Capital Clean Care",
    metaDescription: "Professional house cleaning in Silver Spring, MD. Eco-friendly products, background-checked teams. Serving Downtown, Woodside, Forest Glen, Four Corners. Free quotes.",
    zip: "20910",
