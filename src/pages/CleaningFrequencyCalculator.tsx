        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <FadeInSection>
            <div className="bg-primary text-primary-foreground rounded-2xl p-8 text-center shadow-lg">
              ...
              <p className="text-primary-foreground/80 mb-6 leading-relaxed">Tell us about your home and we&apos;ll turn your recommended cadence into a flat price — eco-friendly, background-checked teams across Montgomery County and the DMV. 5.0 stars on Google.</p>
