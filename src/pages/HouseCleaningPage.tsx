    ...
    <Layout>
      ...
      <section className="py-14 md:py-[4.5rem] bg-white overflow-hidden">
        <div className="container mx-auto px-4 max-w-6xl">
          <Reveal>
            ...
            <div className="flex items-center justify-center gap-1.5 mb-10">
              ...
              <span className="text-sm text-gray-400">· Google Verified · 45 Reviews</span>
            </div>
          </Reveal>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          {/* Real Google reviews — view & leave a review */}
          <Reveal delay={200} className="mt-12 flex flex-col items-center gap-4 text-center">
            <div className="inline-flex items-center gap-2.5 rounded-full bg-white border border-gray-200 px-5 py-2.5 shadow-sm">
              ...
              <span className="text-sm font-semibold text-gray-700">5.0 on Google · 45 reviews</span>
            </div>
            <p className="text-sm text-gray-500">Read every verified review on Google — or leave your own.</p>
            <GoogleBusinessLinks />
          </Reveal>
        </div>
      </section>
