        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <FadeInSection>
            <div className="bg-primary text-primary-foreground rounded-2xl p-8 text-center shadow-lg mt-14">
              ...
              <p className="text-primary-foreground/80 mb-6 leading-relaxed">These ranges reflect quotes prepared for homes across Montgomery County and the wider DMV, including larger Bethesda homes, older Rockville and Silver Spring properties, and Northern Virginia residences. Explore our eco-friendly{" "}<Link to="/services/deep-cleaning" className="underline text-primary-foreground/90 hover:text-white">deep cleaning service</Link>{" "}or local details for{" "}<Link to="/locations/arlington-va/deep-cleaning" className="underline text-primary-foreground/90 hover:text-white">deep cleaning in Arlington, VA</Link>. Every job receives a written scope before booking.</p>
