...
const PrivacyPolicy = () => {
  ...
  return (
    <LegalDoc
      ...
      wide
    >
      <LegalSection id="information-we-collect" image={{ base: "/images/legal/terms-03-pricing", alt: "Clipboard with a blank form, a pen and house keys on a clean kitchen counter" }} title="1. Information We Collect">
      ...
      <LegalSection id="contact" image={{ base: "/images/legal/terms-10-contact", alt: "Capital Clean Care team member on the phone in a bright hallway" }} title="7. Contact Us">
