...
const CANONICAL = "https://capitalcleancare.com/es/limpieza-profunda";
...
export default function LimpiezaProfundaPage() {
  ...
  return (
    <Layout>
      {seoHelmet}
      <BreadcrumbSchema items={[{ label: "Inicio", href: "/es" }, { label: "Limpieza Profunda", href: "/es/limpieza-profunda" }]} />
