...
const CANONICAL = "https://capitalcleancare.com/es/areas/gaithersburg-md";
...
export default function GaithersburgES() {
  ...
  return (
    <Layout>
      {seoHelmet}
      <BreadcrumbSchema items={[{ label: "Inicio", href: "/es" }, { label: "Gaithersburg, MD", href: "/es/areas/gaithersburg-md" }]} />
