...
const CANONICAL = "https://capitalcleancare.com/es/areas/germantown-md";
...
export default function GermantownES() {
  ...
  return (
    <Layout>
      {seoHelmet}
      <BreadcrumbSchema items={[{ label: "Inicio", href: "/es" }, { label: "Germantown, MD", href: "/es/areas/germantown-md" }]} />
