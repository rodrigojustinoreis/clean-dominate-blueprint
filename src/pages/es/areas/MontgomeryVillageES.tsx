...
const CANONICAL = "https://www.capitalcleancare.com/es/areas/montgomery-village-md";

const services = [
  { slug: "/es/limpieza-de-casas", title: "Limpieza Regular", desc: "Mantenimiento semanal, quincenal o mensual en Montgomery Village." },
  { slug: "/es/limpieza-profunda", title: "Limpieza Profunda", desc: "Limpieza completa — ideal para primera visita o renovación." },
  { slug: "/es/limpieza-de-mudanza", title: "Limpieza de Mudanza", desc: "Move-out con garantía de depósito. Perfecto para comunidades de MV." },
  { slug: "/es/limpieza-airbnb", title: "Limpieza Airbnb", desc: "Recambio entre huéspedes con reporte fotográfico." },
  { slug: "/es/limpieza-post-construccion", title: "Post-Construcción", desc: "Después de remodelación — dejamos todo listo para vivir." },
      ...
      <main lang="es">
        <section className="bg-gradient-to-br from-primary/5 via-background to-accent/5 py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-4xl">
            <p className="text-sm font-medium text-accent mb-3 flex items-center gap-1.5"><MapPin className="h-3.5 w-3.5" /> Montgomery Village, MD</p>
            <h1 className="font-heading text-3xl md:text-5xl font-bold text-foreground mb-5 leading-tight">
              Limpieza de Casas en Montgomery Village, MD
            </h1>
        ...
        <section className="py-14 md:py-20">
          <div className="container mx-auto px-4 max-w-5xl">
            <h2 className="font-heading text-2xl font-bold text-foreground mb-8 text-center">Servicios en Montgomery Village</h2>
        ...
        <section className="py-14 bg-secondary/30">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="font-heading text-2xl font-bold text-foreground mb-6 text-center">Áreas de Montgomery Village que cubrimos</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-10">
              {["Lake Forest", "Goshen", "Village Center", "Montgomery Village Ave", "Stedwick", "Watkins Mill", "Whetstone", "South Village", "Mill Creek", "Great Seneca", "Cider Mill", "Flower Hill"].map((n) => (
