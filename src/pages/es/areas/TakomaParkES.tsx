...
const CANONICAL = "https://capitalcleancare.com/es/areas/takoma-park-md";
...
export default function TakomaParkES() {
  ...
  return (
    <Layout>
      {seoHelmet}
      <BreadcrumbSchema items={[{ label: "Inicio", href: "/es" }, { label: "Takoma Park, MD", href: "/es/areas/takoma-park-md" }]} />
