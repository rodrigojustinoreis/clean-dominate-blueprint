...
const CANONICAL = "https://capitalcleancare.com/es/areas/wheaton-md";
...
export default function WheatonES() {
  ...
  return (
    <Layout>
      {seoHelmet}
      <BreadcrumbSchema items={[{ label: "Inicio", href: "/es" }, { label: "Wheaton, MD", href: "/es/areas/wheaton-md" }]} />
        ...
        <section className="bg-gradient-to-br from-primary/5 via-background to-accent/5 py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              {["⭐ 5.0 en Google", "🛡️ Asegurados", "🗣️ Español", "📍 Wheaton"].map((p) => (
