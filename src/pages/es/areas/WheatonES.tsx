  ...
  return (
    <>
      ...
      <main lang="es">
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button variant="outline" size="lg" asChild>
                <a href="#cotizacion" onClick={() => trackBookNowClick("wheaton_es_hero")}>Cotización Gratis <ArrowRight className="ml-1 h-4 w-4" /></a>
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                { stat: "40%", label: "Comunidad Latina" },
                { stat: "SF / Duplexes", label: "Tipo de vivienda" },
                { stat: "~4 mi", label: "Desde Silver Spring" },
              ].map(({ stat, label }) => (
        ...
        <MeetTheTeamSection city="Wheaton" />

        <TransparencySection />

        <div id="cotizacion">
          <QuoteFormES id="cotizacion" submitLabel="Solicitar Cotización en Wheaton" />
        </div>
          ...
          <div className="container mx-auto px-4 max-w-2xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white/50 text-white hover:bg-white/10" asChild>
                <a href="#cotizacion" onClick={() => trackBookNowClick("wheaton_es_cta")}>Cotización Gratis</a>
              </Button>
            </div>
