...
const ChevyChaseAirbnbCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Chevy Chase" citySlug="chevy-chase-md" serviceSlug="airbnb-cleaning" serviceLabel="Airbnb Cleaning" />
      ...
      <LocationQuoteSection cityName="Chevy Chase" serviceLabel="Airbnb Cleaning" defaultService="airbnb" zipLine="Serving Chevy Chase and nearby communities." />
