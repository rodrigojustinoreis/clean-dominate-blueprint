...
const ChevyChaseOfficeCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Chevy Chase" citySlug="chevy-chase-md" serviceSlug="office-cleaning" serviceLabel="Office Cleaning" />
      ...
      <LocationQuoteSection cityName="Chevy Chase" serviceLabel="Office Cleaning" defaultService="office" zipLine="Serving Chevy Chase and nearby communities." />
