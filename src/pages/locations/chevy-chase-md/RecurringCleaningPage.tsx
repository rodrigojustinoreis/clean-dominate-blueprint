...
const ChevyChaseRecurringCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Chevy Chase" citySlug="chevy-chase-md" serviceSlug="recurring-cleaning" serviceLabel="Recurring Cleaning" />
      ...
      <LocationQuoteSection cityName="Chevy Chase" serviceLabel="Recurring Cleaning" defaultService="recurring" zipLine="Serving Chevy Chase and nearby communities." />
