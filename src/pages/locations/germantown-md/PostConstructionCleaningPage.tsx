...
const GermantownPostConstructionCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Germantown" citySlug="germantown-md" serviceSlug="post-construction-cleaning" serviceLabel="Post-Construction Cleaning" />
      ...
      <LocationQuoteSection cityName="Germantown" serviceLabel="Post-Construction Cleaning" defaultService="post-construction" zipLine="Serving Germantown and nearby communities." />
