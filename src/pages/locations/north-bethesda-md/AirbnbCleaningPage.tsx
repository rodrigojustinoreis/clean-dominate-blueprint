...
const NorthBethesdaAirbnbCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="North Bethesda" citySlug="north-bethesda-md" serviceSlug="airbnb-cleaning" serviceLabel="Airbnb Cleaning" />
      ...
      <LocationQuoteSection cityName="North Bethesda" serviceLabel="Airbnb Cleaning" defaultService="airbnb" zipLine="Serving North Bethesda and nearby communities." />
