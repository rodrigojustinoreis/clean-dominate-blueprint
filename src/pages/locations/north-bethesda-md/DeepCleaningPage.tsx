...
const NorthBethesdaDeepCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="North Bethesda" citySlug="north-bethesda-md" serviceSlug="deep-cleaning" serviceLabel="Deep Cleaning" />
      ...
      <LocationQuoteSection cityName="North Bethesda" serviceLabel="Deep Cleaning" defaultService="deep" zipLine="Serving North Bethesda and nearby communities." />
