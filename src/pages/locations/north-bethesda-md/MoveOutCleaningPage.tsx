...
const NorthBethesdaMoveOutCleaningPage = () => {
  const { seoHelmet } = useSEO({
    title: "Move Out Cleaning in North Bethesda, MD — Get Your Full Deposit Back",
    description:
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-8">
            ...
            <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground">
              North Bethesda Renters Trust Capital Clean Care
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-card border border-border rounded-xl p-5">
              ...
              <p className="text-sm text-foreground italic mb-3 leading-relaxed">
                "Capital Clean Care made our move out completely stress-free. The apartment looked better than when we moved in — got our full deposit back without any issues."
              </p>
              <p className="text-sm font-semibold text-foreground">Jennifer R.</p>
            ...
            <div className="bg-card border border-border rounded-xl p-5 flex flex-col items-center justify-center text-center gap-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Serving North Bethesda renters near White Flint, Garrett Park Estates, and the Rockville Pike corridor.
                Recently moved? Share your experience.
              </p>
              <a
      ...
      <section id="quote" className="py-12 md:py-16 bg-muted/30">
        <div className="container mx-auto px-4 max-w-2xl text-center">
          ...
          <p className="text-muted-foreground mb-6 leading-relaxed">
            Serving all North Bethesda ZIPs (20852, 20895), including Garrett Park and the Pike & Rose area.
            Get a free quote in 60 seconds — or call us directly at (240) 704-2551.
            Same-day and next-day slots available. 100% satisfaction guaranteed.
          </p>
