...
const NorthBethesdaOfficeCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="North Bethesda" citySlug="north-bethesda-md" serviceSlug="office-cleaning" serviceLabel="Office Cleaning" />
      ...
      <LocationQuoteSection cityName="North Bethesda" serviceLabel="Office Cleaning" defaultService="office" zipLine="Serving North Bethesda and nearby communities." />
