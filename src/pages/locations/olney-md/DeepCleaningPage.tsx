...
const OlneyDeepCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Olney" citySlug="olney-md" serviceSlug="deep-cleaning" serviceLabel="Deep Cleaning" />
      ...
      <LocationQuoteSection cityName="Olney" serviceLabel="Deep Cleaning" defaultService="deep" zipLine="Serving Olney and nearby communities." />
