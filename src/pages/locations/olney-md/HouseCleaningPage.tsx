...
const OlneyHouseCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Olney" citySlug="olney-md" serviceSlug="house-cleaning" serviceLabel="House Cleaning" />
      ...
      <LocationQuoteSection cityName="Olney" serviceLabel="House Cleaning" defaultService="standard" zipLine="Serving Olney and nearby communities." />
