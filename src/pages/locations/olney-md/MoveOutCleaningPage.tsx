...
const OlneyMoveOutCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Olney" citySlug="olney-md" serviceSlug="move-out-cleaning" serviceLabel="Move-Out Cleaning" />
      ...
      <LocationQuoteSection cityName="Olney" serviceLabel="Move-Out Cleaning" defaultService="move" zipLine="Serving Olney and nearby communities." />
