...
const OlneyRecurringCleaningPage = () => {
  const { seoHelmet } = useSEO({
    title: "Recurring House Cleaning in Olney, MD",
    description:
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Olney" citySlug="olney-md" serviceSlug="recurring-cleaning" serviceLabel="Recurring Cleaning" />
      ...
      <LocationQuoteSection cityName="Olney" serviceLabel="Recurring Cleaning" defaultService="recurring" zipLine="Serving Olney and nearby communities." />
