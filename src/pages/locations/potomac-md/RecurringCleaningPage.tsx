...
const PotomacRecurringCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Potomac" citySlug="potomac-md" serviceSlug="recurring-cleaning" serviceLabel="Recurring Cleaning" />
      ...
      <LocationQuoteSection cityName="Potomac" serviceLabel="Recurring Cleaning" defaultService="recurring" zipLine="Serving Potomac and nearby communities." />
