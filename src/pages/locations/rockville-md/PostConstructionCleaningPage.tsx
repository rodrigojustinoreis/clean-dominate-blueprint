...
const faqs = [
  {
    ...
    a: "Priced by square footage and scope of the project. Get your exact quote in 60 seconds — free, no commitment. We typically schedule within 24–48 hours of your request throughout Rockville.",
  },
  {
  ...
  {
    q: "How soon after construction can you come to Rockville?",
    a: "As soon as your contractors are done. We typically schedule within 24–48 hours of your request throughout all Rockville ZIP codes: 20850, 20851, 20852, and 20853.",
  },
  {
    q: "Can you handle larger commercial post-construction projects in Rockville?",
  ...
  },
  {
    ...
    a: "Yes, with appropriate protocols to protect the occupied areas. Many Rockville clients have multi-phase renovations and need interim cleaning while work continues on other sections.",
  },
  {
    q: "Is Capital Clean Care locally owned?",
    a: "Yes — we are a Latino-owned and operated cleaning company serving Rockville and the greater Montgomery County area. We've cleaned post-construction homes throughout King Farm, Fallsgrove, and Twinbrook.",
  },
];
  ...
  return (
    <Layout>
      ...
      <ServiceSchema
        ...
        description="Post-construction and post-renovation cleaning in Rockville, MD. HEPA-equipped team for drywall dust, paint splatters, and construction residue. Three-phase process. Move-in ready results guaranteed."
        url={PAGE_URL}
      ...
      <HeroLocation
        ...
        lead="Renovation done — now comes the real challenge. Construction dust, drywall residue, paint splatters, and debris settle into every corner of your Rockville home, from King Farm to Twinbrook. Capital Clean Care's HEPA-equipped team delivers a complete, dust-free clean that leaves your property genuinely move-in ready."
        cityName="Rockville"
        state="MD"
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-6">
            Why Post-Construction Requires a Specialist in Rockville
          </h2>
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Construction dust — especially drywall silica — settles into HVAC vents, inside cabinets,
              and on every horizontal surface in your Rockville home. In the 20850 and 20851 ZIP codes
              we serve near Rockville Pike, we regularly encounter renovations where fine dust has
              penetrated into places a standard cleaning crew without HEPA equipment would simply
            ...
            <p>
              ...
              post-construction clean through a standard checklist; we approach each project by the
              scope of the work that was done.
            </p>
          </div>

          {/* Who Books */}
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mt-10 mb-6">
            Who Books Post-Construction Cleaning in Rockville
          </h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              "Homeowners after kitchen, bathroom, or whole-home renovations in Fallsgrove",
              "General contractors preparing final project delivery near Rockville Pike",
              "Developers completing new construction in 20850 and 20853",
              "Real estate investors preparing rental properties in Twinbrook",
              "Commercial property managers after tenant build-outs",
              "Homeowners after basement finishing in King Farm",
            ].map((item) => (
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-8">
            ...
            <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground">
              Rockville Homeowners After Their Renovations
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-card border border-border rounded-xl p-5 flex flex-col items-center justify-center text-center gap-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Serving Rockville renovations from King Farm to Fallsgrove. Share your post-renovation experience.
              </p>
              <a
      ...
      {/* Rockville Renovation Market */}
      <section className="py-12 md:py-16 bg-muted/30">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-6">
            Serving Rockville's Active Home Renovation Market
          </h2>
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Rockville is one of Montgomery County's most active home renovation markets.
              Older homes in Twinbrook and along Veirs Mill Road routinely undergo full kitchen
              and bathroom renovations. Master-planned communities like King Farm and Fallsgrove
              see phased renovations as properties change hands and owners update finishes.
              In the 20852 ZIP code near Rockville Pike, condo and townhome owners frequently
              complete flooring and tile installations that leave fine drywall silica and grout
              haze in every corner — in HVAC vents, inside cabinets, along baseboards, and on
              window tracks.
            </p>
            <p>
              Capital Clean Care has cleaned post-renovation homes throughout all of these
              neighborhoods. A renovation in a 1980s Twinbrook split-level leaves different
              dust profiles than a kitchen remodel in a newer King Farm townhome. Our
              HEPA-equipped team approaches each project by the scope and nature of what
              was done — not a generic checklist applied uniformly regardless of whether
              the work was a single bathroom tile replacement or a full-floor renovation.
            </p>
            <p>
              For general contractors completing projects in 20850 or 20853, we offer white-label
              final cleaning services that you can present to your client as part of your
              project delivery package. Fully insured, bonded, and consistent — we won't
              embarrass you on your final walkthrough. Many Rockville contractors maintain
              ongoing relationships with Capital Clean Care precisely because our post-construction
              results hold up to a homeowner's first close inspection of their renovated space.
              Call (240) 704-2551 to discuss recurring post-construction partnerships for active
              project pipelines throughout Rockville.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="quote" className="py-12 md:py-16 bg-muted/30">
        <div className="container mx-auto px-4 max-w-2xl text-center">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-3">
            Ready for a Dust-Free Home in Rockville?
          </h2>
          <p className="text-muted-foreground mb-6 leading-relaxed">
            Serving Rockville renovations near Montgomery College, across ZIPs 20850, 20851, 20852,
            and 20853. Get a free post-construction cleaning quote in 60 seconds — or call
