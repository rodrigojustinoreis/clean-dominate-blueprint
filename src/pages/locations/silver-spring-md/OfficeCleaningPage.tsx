...
const SilverSpringOfficeCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Silver Spring" citySlug="silver-spring-md" serviceSlug="office-cleaning" serviceLabel="Office Cleaning" />
      ...
      <LocationQuoteSection cityName="Silver Spring" serviceLabel="Office Cleaning" defaultService="office" zipLine="Serving Silver Spring and nearby communities." />
