...
const WheatonAirbnbCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Wheaton" citySlug="wheaton-md" serviceSlug="airbnb-cleaning" serviceLabel="Airbnb Cleaning" />
      ...
      <LocationQuoteSection cityName="Wheaton" serviceLabel="Airbnb Cleaning" defaultService="airbnb" zipLine="Serving Wheaton and nearby communities." />
