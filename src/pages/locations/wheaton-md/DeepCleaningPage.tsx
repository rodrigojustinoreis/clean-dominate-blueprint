...
const WheatonDeepCleaningPage = () => {
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Wheaton" citySlug="wheaton-md" serviceSlug="deep-cleaning" serviceLabel="Deep Cleaning" />
      ...
      <LocationQuoteSection cityName="Wheaton" serviceLabel="Deep Cleaning" defaultService="deep" zipLine="Serving Wheaton and nearby communities." />
