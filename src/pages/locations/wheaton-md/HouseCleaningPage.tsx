...
const WheatonHouseCleaningPage = () => {
  const { seoHelmet } = useSEO({
    title: "House Cleaning in Wheaton, MD",
    description:
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Wheaton" citySlug="wheaton-md" serviceSlug="house-cleaning" serviceLabel="House Cleaning" />
      ...
      <LocationQuoteSection cityName="Wheaton" serviceLabel="House Cleaning" defaultService="standard" zipLine="Serving Wheaton and nearby communities." />
