...
const WheatonRecurringCleaningPage = () => {
  const { seoHelmet } = useSEO({
    title: "Recurring House Cleaning in Wheaton, MD",
    description:
  ...
  return (
    <Layout>
      ...
      <LocationSocialProof cityName="Wheaton" citySlug="wheaton-md" serviceSlug="recurring-cleaning" serviceLabel="Recurring Cleaning" />
      ...
      <LocationQuoteSection cityName="Wheaton" serviceLabel="Recurring Cleaning" defaultService="recurring" zipLine="Serving Wheaton and nearby communities." />
